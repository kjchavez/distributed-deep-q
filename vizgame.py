...
class Visualizer(object):
    ...
    def record(self, action, reward, frame, newfile=False):
        if not newfile:
            ...
            with tb.open_file("history.h5", "a") as f:
                ...
                h = f.create_table(exp, "history", self.Experience,
                                   "(action, rewards)")
    ...
    def view_images(self, frames):
        ...
        sframe = self.DiscreteSlider(axframe, "Frame no.", 0, len(frames) - 1,
